...
You can either follow the steps below to run this project from your local machine, or you can directly access the deployed site here: 

[__fill in link__](__fill in link__)
...
* Create a postgres database called 'badmusician'
